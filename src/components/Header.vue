<template>
  <header class="banner">
    ...
    <img src="../assets/imagens/foto-banner.png" alt="Foto de uma mulher cozinhando com uma bacia de vidro em mãos. Ela está sorrindo e está apoiando um celular entre seu rosto e ombro" class="foto-banner">
  </header>
</template>
<style scoped>
.banner {
